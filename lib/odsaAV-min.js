...
(function(e) {
  ...
  e.extend(true, JSAV._translations, r);
  ...
  n.showGrade = function() {
    ...
    e(".jsavexercisecontrols").addClass("active");
    e('.jsavexercisecontrols input[name="grade"]').attr("disabled", "disabled");
    this.grade();
    this.jsav.logEvent({
    ...
    var t = this.jsav._translate,
      s = i(this),
      r = this.score;
    var n = [PARAMS.submission_url, s, r.correct, r.total].join(":");
    var o = t("yourScore") + " " + r.correct + " / " + r.total + "\n\n";
    ...
    e.ajax(PARAMS.submit_url, {
      ...
      console.log("DEBUG from odsaAV-min.js: received from mooc-grader: " + e)
      if (e.success) {
        o += t("ajaxSuccess")
      } else {
        o += t("ajaxError") + e.message
      }
    ...
    e(".jsavexercisecontrols").removeClass("active")
  }
})(jQuery);
