 ...
 */(function(e){function s(e){return e._jsondump()}var t=PARAMS.seed||Math.floor(Math.random()*99999999999999).toString();JSAV.utils.rand.seedrandom(t),Math.random=JSAV.utils.rand.random,ODSA.SETTINGS.MODULE_ORIGIN="*";var n=function(e){return e.map(function(e){return String.fromCharCode(e-7)}).join("")}([123,62,61,120,60,59,78,125]),r=JSAV.ext.exercise;JSAV.ext.exercise=function(t,n,i){return i=e.extend(i,{feedback:"atend"}),r.call(this,t,n,i)},e("#help").remove(),e("#about").remove();var i={en:{ajaxSuccess:"Your score was successfully recorded.",ajaxError:"Error while submitting your solution: ",ajaxFailed:"Unfortunately recordind your solution failed."},fi:{ajaxSuccess:"Pisteesi tallennettiin onnistuneesti.",ajaxError:"Ratkaisuasi lähettäessä tapahtui virhe: ",ajaxFailed:"Valitettavasti ratkaisuasi ei pystytty tallentamaan."}};e.extend(!0,JSAV._translations,i);var o=JSAV._types.Exercise.prototype;o.originalModel=o.showModelanswer,o.originalReset=o.reset,o.showModelanswer=function(){this.modelSeenFlag=!0,e('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),this.originalModel()},o.reset=function(){this.originalReset(),delete this.modelSeenFlag,e('.jsavexercisecontrols input[name="grade"]').removeAttr("disabled")},o.showGrade=function(){if(this.modelSeenFlag)return;e(".jsavexercisecontrols").addClass("active"),e('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),this.grade(),this.jsav.logEvent({type:"jsav-exercise-grade-button",score:e.extend({},this.score)});var t=this.jsav._translate,r=s(this),i=this.score,o=[PARAMS.submission_url,r,i.correct,i.total].join(":"),u=t("yourScore")+" "+i.correct+" / "+i.total+"\n\n";e.ajax(PARAMS.submit_url,{type:"POST",data:{checksum:md5(n+o),submission_url:PARAMS.submission_url,answer:r,points:i.correct,max_points:i.total}}).done(function(e){e.success?u+=t("ajaxSuccess"):u+=t("ajaxError")+e.message,window.parent.postMessage({type:"a-plus-refresh-stats"},"*"),setTimeout(function(){alert(u)},0)}).fail(function(){alert(t("ajaxFailed"))}),e(".jsavexercisecontrols").removeClass("active")}})(jQuery);