...
!function(u){var e=PARAMS.seed||Math.floor(99999999999999*Math.random()).toString();JSAV.utils.rand.seedrandom(e),Math.random=JSAV.utils.rand.random,ODSA.SETTINGS.MODULE_ORIGIN="*";var s=JSAV.ext.exercise;JSAV.ext.exercise=function(e,a,t){return t=u.extend(t,{feedback:"atend"}),s.call(this,e,a,t)},u("#help").remove(),u("#about").remove(),u.extend(!0,JSAV._translations,{en:{ajaxSuccess:"Your score was successfully recorded.",ajaxError:"Error while submitting your solution: ",ajaxFailed:"Unfortunately recording your solution failed.",compareButton:"Compare answers",compareNote:'You can view the differences between your answer and the model answer\nby clicking the "Compare answers" button.'},fi:{ajaxSuccess:"Pisteesi tallennettiin onnistuneesti.",ajaxError:"Ratkaisuasi lähettäessä tapahtui virhe: ",ajaxFailed:"Valitettavasti ratkaisuasi ei pystytty tallentamaan.",compareButton:"Vertaile vastauksia",compareNote:'Voit katsoa oman vastauksesi ja mallivastauksen eron\n"Vertaile vastauksia" -napista.'}});var a=JSAV._types.Exercise.prototype;a.originalModel=a.showModelanswer,a.originalReset=a.reset,a.showModelanswer=function(){this.modelSeenFlag=!0,u('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),u('.jsavexercisecontrols input[name="player"]').attr("disabled","disabled"),this.originalModel()},a.reset=function(){this.originalReset(),delete this.modelSeenFlag,u('.jsavexercisecontrols input[name="grade"]').removeAttr("disabled"),u('.jsavexercisecontrols input[name="player"]').attr("disabled","disabled")};var o=null,t="",r=null;function n(e){var a="",a="string"!=typeof e?btoa(JSON.stringify(e)):e.replace(/[^\x00-\x7F]/g,""),t=[PARAMS.submission_url,a,r.score.correct,r.score.total].join(":");u.ajax(PARAMS.submit_url,{type:"POST",data:{checksum:md5(PARAMS.ajax_key+t),submission_url:PARAMS.submission_url,answer:a,points:r.score.correct,max_points:r.score.total,ajax_key:PARAMS.ajax_key}}).done(i).fail(l),u(".jsavexercisecontrols").removeClass("active")}function i(e){e.success?t+=o("ajaxSuccess"):t+=o("ajaxError")+e.message,"undefined"!=typeof JSAVrecorder&&(t+="\n"+o("compareNote")),window.parent.postMessage({type:"a-plus-refresh-stats"},"*"),setTimeout(function(){!function(){if("undefined"==typeof JSAVrecorder)return;{var e;0<u('.jsavexercisecontrols > input[name="player"]').length?u('.jsavexercisecontrols input[name="player"]').removeAttr("disabled"):(e='<input type="button" name="player" id="show-player" value="'+o("compareButton")+'">',u(".jsavexercisecontrols").append(e).click(function(){c("JAAL Player should activate")}))}}(),c(t)},0)}function l(){c(o("ajaxFailed"))}function c(e){var a='<div id="jsavalertbox"><p>'+e.replace("\n","<br>")+'</p><input type="button" name="ok" value="OK"></div>',t=u(".jsavcontainer");t.append(a);var s=u("#jsavalertbox"),r=u("#jsavalertbox > :button");s.css("width","400px"),s.css("padding","1ex"),s.css("border","1px solid black"),s.css("border-radius","5px"),s.css("background","#eee"),s.css("position","absolute"),r.css("display","block"),r.css("margin-left","auto"),r.css("margin-right","auto"),u("#jsavalertbox > p").css("margin-top","0px");var o=t.prop("clientWidth"),n=t.prop("clientHeight"),i=s.prop("clientWidth"),l=s.prop("clientHeight"),c=Math.floor(.5*(o-i)),d=Math.floor(.5*n-l);s.css("z-index","1000"),s.css("left",c),s.css("top",d),r.click(function(){u("#jsavalertbox").remove()})}a.showGrade=function(){if((r=this).modelSeenFlag)console.warn("Exercise had modelSeenFlag set, but showGrade() was called! This should not happen.");else{o=r.jsav._translate,u(".jsavexercisecontrols").addClass("active"),u('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),r.grade(),t=function(e,a){var t=0,s=0;{var r;s=PARAMS.max_points?(r=parseInt(PARAMS.max_points,10)/a,t=Math.floor(e*r),Math.floor(a*r)):(t=e,a)}return o("yourScore")+" "+t+" / "+s+"\n\n"}(r.score.correct,r.score.total);try{JSAVrecorder.sendSubmission=n,r.jsav.logEvent({type:"jsav-exercise-grade-button",score:u.extend({},this.score)})}catch(e){r.jsav.logEvent({type:"jsav-exercise-grade-button",score:u.extend({},this.score)}),n(r._jsondump().replace(/[^\x00-\x7F]/g,""))}}}}(jQuery);
