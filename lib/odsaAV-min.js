...
!function(s){var e=PARAMS.seed||Math.floor(99999999999999*Math.random()).toString();JSAV.utils.rand.seedrandom(e),Math.random=JSAV.utils.rand.random,ODSA.SETTINGS.MODULE_ORIGIN="*";var r=JSAV.ext.exercise;JSAV.ext.exercise=function(e,a,t){return t=s.extend(t,{feedback:"atend"}),r.call(this,e,a,t)},s("#help").remove(),s("#about").remove(),s.extend(!0,JSAV._translations,{en:{ajaxSuccess:"Your score was successfully recorded.",ajaxError:"Error while submitting your solution: ",ajaxFailed:"Unfortunately recording your solution failed.",compareButton:"Compare answers",compareNote:'You can view the differences between your answer and the model answer\nby clicking the "Compare answers" button.'},fi:{ajaxSuccess:"Pisteesi tallennettiin onnistuneesti.",ajaxError:"Ratkaisuasi lähettäessä tapahtui virhe: ",ajaxFailed:"Valitettavasti ratkaisuasi ei pystytty tallentamaan.",compareButton:"Vertaile vastauksia",compareNote:'Voit katsoa oman vastauksesi ja mallivastauksen eron\n"Vertaile vastauksia" -napista.'}});var a=JSAV._types.Exercise.prototype;a.originalModel=a.showModelanswer,a.originalReset=a.reset,a.showModelanswer=function(){this.modelSeenFlag=!0,s('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),s('.jsavexercisecontrols input[name="player"]').attr("disabled","disabled"),this.originalModel()},a.reset=function(){this.originalReset(),delete this.modelSeenFlag,s('.jsavexercisecontrols input[name="grade"]').removeAttr("disabled"),s('.jsavexercisecontrols input[name="player"]').attr("disabled","disabled")};var o=null,t="",n=null;function i(e){var a="",a="string"!=typeof e?btoa(JSON.stringify(e)):e.replace(/[^\x00-\x7F]/g,""),t=[PARAMS.submission_url,a,n.score.correct,n.score.total].join(":");s.ajax(PARAMS.submit_url,{type:"POST",data:{checksum:md5(PARAMS.ajax_key+t),submission_url:PARAMS.submission_url,answer:a,points:n.score.correct,max_points:n.score.total,ajax_key:PARAMS.ajax_key}}).done(l).fail(c),s(".jsavexercisecontrols").removeClass("active")}function l(e){e.success?t+=o("ajaxSuccess"):t+=o("ajaxError")+e.message,"undefined"!=typeof JSAVrecorder&&(t+="\n"+o("compareNote")),window.parent.postMessage({type:"a-plus-refresh-stats"},"*"),setTimeout(function(){!function(){if("undefined"==typeof JSAVrecorder)return;{var e;0<s('.jsavexercisecontrols > input[name="player"]').length?s('.jsavexercisecontrols input[name="player"]').removeAttr("disabled"):(e='<input type="button" name="player" value="'+o("compareButton")+'">',s(".jsavexercisecontrols").append(e).click(function(){alert("JAAL Player should activate")}))}}(),alert(t)},0)}function c(){alert(o("ajaxFailed"))}a.showGrade=function(){if((n=this).modelSeenFlag)console.warn("Exercise had modelSeenFlag set, but showGrade() was called! This should not happen.");else{o=n.jsav._translate,s(".jsavexercisecontrols").addClass("active"),s('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),n.grade(),t=function(e,a){var t=0,s=0;{var r;s=PARAMS.max_points?(r=parseInt(PARAMS.max_points,10)/a,t=Math.floor(e*r),Math.floor(a*r)):(t=e,a)}return o("yourScore")+" "+t+" / "+s+"\n\n"}(n.score.correct,n.score.total);try{JSAVrecorder.sendSubmission=i,n.jsav.logEvent({type:"jsav-exercise-grade-button",score:s.extend({},this.score)})}catch(e){n.jsav.logEvent({type:"jsav-exercise-grade-button",score:s.extend({},this.score)}),i(n._jsondump().replace(/[^\x00-\x7F]/g,""))}}}}(jQuery);
