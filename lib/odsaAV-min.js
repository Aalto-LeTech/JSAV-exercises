...
(function(e) {
  ...
  n.showGrade = function() {
    ...
    var translation = this.jsav._translate;
    ...
    if (PARAMS['max_points']) {
      ...
      o = translation("yourScore") + " " + Math.floor(r.correct * scale) + " / " +
    ...
    $.ajax(PARAMS.submit_url, {
      ...
      if (response.success) {
        o += translation("ajaxSuccess")
      } else {
        o += translation("ajaxError") + response.message
      }
