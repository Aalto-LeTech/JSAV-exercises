...
!function(t){var e=PARAMS.seed||Math.floor(99999999999999*Math.random()).toString();JSAV.utils.rand.seedrandom(e),Math.random=JSAV.utils.rand.random,ODSA.SETTINGS.MODULE_ORIGIN="*";var r=JSAV.ext.exercise;JSAV.ext.exercise=function(e,a,s){return s=t.extend(s,{feedback:"atend"}),r.call(this,e,a,s)},t("#help").remove(),t("#about").remove(),t.extend(!0,JSAV._translations,{en:{ajaxSuccess:"Your score was successfully recorded.",ajaxError:"Error while submitting your solution: ",ajaxFailed:"Unfortunately recording your solution failed."},fi:{ajaxSuccess:"Pisteesi tallennettiin onnistuneesti.",ajaxError:"Ratkaisuasi lähettäessä tapahtui virhe: ",ajaxFailed:"Valitettavasti ratkaisuasi ei pystytty tallentamaan."}});var a=JSAV._types.Exercise.prototype;a.originalModel=a.showModelanswer,a.originalReset=a.reset,a.showModelanswer=function(){this.modelSeenFlag=!0,t('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),this.originalModel()},a.reset=function(){this.originalReset(),delete this.modelSeenFlag,t('.jsavexercisecontrols input[name="grade"]').removeAttr("disabled")};var o=null,s="",n=null;function i(e){var a="",a="string"!=typeof e?btoa(JSON.stringify(e)):e.replace(/[^\x00-\x7F]/g,""),s=[PARAMS.submission_url,a,n.score.correct,n.score.total].join(":");t.ajax(PARAMS.submit_url,{type:"POST",data:{checksum:md5(PARAMS.ajax_key+s),submission_url:PARAMS.submission_url,answer:a,points:n.score.correct,max_points:n.score.total,ajax_key:PARAMS.ajax_key}}).done(l).fail(c),t(".jsavexercisecontrols").removeClass("active")}function l(e){e.success?s+=o("ajaxSuccess"):s+=o("ajaxError")+e.message,window.parent.postMessage({type:"a-plus-refresh-stats"},"*"),setTimeout(function(){alert(s)},0)}function c(){alert(o("ajaxFailed"))}a.showGrade=function(){if((n=this).modelSeenFlag)console.warn("Exercise had modelSeenFlag set, but showGrade() was called! This should not happen.");else{o=n.jsav._translate,t(".jsavexercisecontrols").addClass("active"),t('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),n.grade(),s=function(e,a){var s=0,t=0;{var r;t=PARAMS.max_points?(r=parseInt(PARAMS.max_points,10)/a,s=Math.floor(e*r),Math.floor(a*r)):(s=e,a)}return o("yourScore")+" "+s+" / "+t+"\n\n"}(n.score.correct,n.score.total);try{JSAVrecorder.sendSubmission=i,n.jsav.logEvent({type:"jsav-exercise-grade-button",score:t.extend({},this.score)})}catch(e){n.jsav.logEvent({type:"jsav-exercise-grade-button",score:t.extend({},this.score)}),i(n._jsondump().replace(/[^\x00-\x7F]/g,""))}}}}(jQuery);
