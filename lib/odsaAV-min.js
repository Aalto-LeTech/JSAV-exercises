...
!function(u){var e=PARAMS.seed||Math.floor(99999999999999*Math.random()).toString();JSAV.utils.rand.seedrandom(e),Math.random=JSAV.utils.rand.random,ODSA.SETTINGS.MODULE_ORIGIN="*";var t=JSAV.ext.exercise;JSAV.ext.exercise=function(e,a,s){return s=u.extend(s,{feedback:"atend"}),t.call(this,e,a,s)},u("#help").remove(),u("#about").remove(),u.extend(!0,JSAV._translations,{en:{ajaxSuccess:"Your score was successfully recorded.",ajaxError:"Error while submitting your solution: ",ajaxFailed:"Unfortunately recording your solution failed.",compareButton:"Compare answers",compareNote:'You can view the differences between your answer and the model answer\nby clicking the "Compare answers" button.'},fi:{ajaxSuccess:"Pisteesi tallennettiin onnistuneesti.",ajaxError:"Ratkaisuasi lähettäessä tapahtui virhe: ",ajaxFailed:"Valitettavasti ratkaisuasi ei pystytty tallentamaan.",compareButton:"Vertaile vastauksia",compareNote:'Voit katsoa oman vastauksesi ja mallivastauksen eron\n"Vertaile vastauksia" -napista.'}});var a=JSAV._types.Exercise.prototype;a.originalModel=a.showModelanswer,a.originalReset=a.reset,a.showModelanswer=function(){this.modelSeenFlag=!0,u('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),u('.jsavexercisecontrols input[name="player"]').attr("disabled","disabled"),this.originalModel()},a.reset=function(){this.originalReset(),delete this.modelSeenFlag,u('.jsavexercisecontrols input[name="grade"]').removeAttr("disabled"),u('.jsavexercisecontrols input[name="player"]').attr("disabled","disabled")};var o=null,s="",r=null;function n(e){var a="";if("string"!=typeof e)try{a=window.JSAVrecorder.escapeRecording(e)}catch(e){console.error("sendSubmission(): got an exception: "+e)}else a=e.replace(/[^\x00-\x7F]/g,"");var s=[PARAMS.submission_url,a,r.score.correct,r.score.total].join(":");u.ajax(PARAMS.submit_url,{type:"POST",data:{checksum:md5(PARAMS.ajax_key+s),submission_url:PARAMS.submission_url,answer:a,points:r.score.correct,max_points:r.score.total,ajax_key:PARAMS.ajax_key}}).done(i).fail(c),u(".jsavexercisecontrols").removeClass("active")}function i(e){e.success?s+=o("ajaxSuccess"):s+=o("ajaxError")+e.message,window.parent.postMessage({type:"a-plus-refresh-stats"},"*"),setTimeout(function(){l(s)},0)}function c(){l(o("ajaxFailed"))}function l(e){var a='<div id="jsavalertbox"><p>'+e.replace("\n","<br>")+'</p><input type="button" name="ok" value="OK"></div>',s=u(".jsavcontainer");s.append(a);var t=u("#jsavalertbox"),r=u("#jsavalertbox > :button");t.css("width","400px"),t.css("padding","1ex"),t.css("border","1px solid black"),t.css("border-radius","5px"),t.css("background","#eee"),t.css("position","absolute"),r.css("display","block"),r.css("margin-left","auto"),r.css("margin-right","auto"),u("#jsavalertbox > p").css("margin-top","0px");var o=s.prop("clientWidth"),n=s.prop("clientHeight"),i=t.prop("clientWidth"),c=t.prop("clientHeight"),l=Math.floor(.5*(o-i)),d=Math.floor(.5*n-c);t.css("z-index","1000"),t.css("left",l),t.css("top",d),r.click(function(){u("#jsavalertbox").remove()})}a.showGrade=function(){if((r=this).modelSeenFlag)console.warn("Exercise had modelSeenFlag set, but showGrade() was called! This should not happen.");else{o=r.jsav._translate,u(".jsavexercisecontrols").addClass("active"),u('.jsavexercisecontrols input[name="grade"]').attr("disabled","disabled"),r.grade(),s=function(e,a){var s=0,t=0;{var r;t=PARAMS.max_points?(r=parseInt(PARAMS.max_points,10)/a,s=Math.floor(e*r),Math.floor(a*r)):(s=e,a)}return o("yourScore")+" "+s+" / "+t+"\n\n"}(r.score.correct,r.score.total);try{JSAVrecorder.sendSubmission=n,r.jsav.logEvent({type:"jsav-exercise-grade-button",score:u.extend({},this.score)})}catch(e){r.jsav.logEvent({type:"jsav-exercise-grade-button",score:u.extend({},this.score)}),n(r._jsondump().replace(/[^\x00-\x7F]/g,""))}}}}(jQuery);
