...
module.exports = {
  ...
  setFinalGrade,
  modelAnswer: {
    record: modelAnswer.recordModelAnswer,
...
// Records the model answer.
// JAAL: definitions.modelAnswer.steps[i]
// Parameters:
//     exercise: a JSAV exercise
function recordModelAnswer(exercise) {
  console.log("Exercise Recorder: recordModelAnswer() begins!")
  console.log("Exercise Recorder: recordModelAnswer() ends!")
}
...
global.JSAVrecorder = {
  getRecording: function() {
    def_func.modelAnswer.record(exercise);
